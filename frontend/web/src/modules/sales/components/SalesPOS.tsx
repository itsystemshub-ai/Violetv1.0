    ...
    <Card className="group relative flex flex-col h-full bg-card hover:shadow-2xl transition-all duration-500 border border-border/40 hover:border-primary/30 overflow-hidden rounded-4xl">
      ...
      <div className="relative aspect-square w-full px-8 py-6 flex items-center justify-center bg-transparent group-hover:bg-primary/5 transition-colors text-center z-10">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-background/20 dark:bg-black/20 rounded-lg">
            <ZoomIn className="w-12 h-12 text-primary dark:text-white drop-shadow-lg" />
          </div>
        </div>

        {/* Indicador de cantidad de fotos */}
        {images.length > 1 && (
          <div className="absolute bottom-2 right-2 bg-background/80 dark:bg-black/70 text-foreground dark:text-white text-xs px-2.5 py-1 rounded-full font-bold shadow-lg z-30 border border-border/50">
        ...
        {images.length > 1 && (
          <>
            <button
              onClick={prevImage}
              className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-background/80 dark:bg-black/50 hover:bg-background dark:hover:bg-black/70 text-foreground dark:text-white rounded-full opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center z-30 shadow-lg border border-border/50"
              title="Foto anterior"
            >
            ...
            <button
              onClick={nextImage}
              className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-background/80 dark:bg-black/50 hover:bg-background dark:hover:bg-black/70 text-foreground dark:text-white rounded-full opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center z-30 shadow-lg border border-border/50"
              title="Foto siguiente"
            >

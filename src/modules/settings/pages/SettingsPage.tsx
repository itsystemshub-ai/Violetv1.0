...
function getActiveSection(pathname: string): string {
  ...
  if (pathname.includes("/settings/password-requests")) return "password-requests";
...
export default function SettingsPage() {
  ...
  const { auditLogs, syncLogs, dbStats, isLoading: isLoadingAudit, purgeAuditLogs, refresh: refreshAudit } = useAudit();

          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-1 group">
              ...
              <Input
                ...
                className="pl-12 h-12 rounded-2xl bg-white/50 dark:bg-slate-900/50 border-white/10 shadow-inner"
              />
            </div>
            ...
            <div className="flex gap-2 w-full md:w-auto">
              ...
              >
                <SelectTrigger className="w-[180px] h-12 rounded-2xl bg-white/50 dark:bg-slate-900/50 border-white/10 overflow-hidden">
              ...
              <Button
                variant="outline"
                className="h-12 w-12 rounded-2xl bg-white/50 dark:bg-slate-900/50 border-white/10 shrink-0 shadow-sm"
              >

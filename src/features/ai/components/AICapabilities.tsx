/**
 * AICapabilities - Gestión de capacidades y skills de IA
 */

import React from 'react';
import { Zap, Code, Palette, Database, TestTube, Bug, FileCode, Layers } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Gestiona las skills y capacidades disponibles para el asistente de IA
          </CardDescription>
        </CardHeader>
        <CardContent>

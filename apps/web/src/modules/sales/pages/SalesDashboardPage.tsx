    ...
    <ValeryLayout sidebar={<ValerySidebar />}>
      ...
      <main className="container mx-auto p-4 md:p-8 space-y-8 relative h-full overflow-y-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm p-6 rounded-3xl">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              className="h-9 gap-2 rounded-xl bg-violet-500/10 border-violet-500/20 text-violet-600 hover:bg-violet-500/20"
              onClick={() => {
                automationHub.trigger("/reports/predictive-sales", {
                  tenantId: tenant?.id,
                  requestedBy: "user-id", // Placeholder
                  period: "next_7_days",
                });
                toast.success("Solicitud de reporte predictivo enviada a n8n");
              }}
            >
            ...
            <Button
              variant="default"
              size="sm"
              className="h-9 gap-2 rounded-xl shadow-lg shadow-primary/20"
            >
        ...
        <Tabs defaultValue="overview" className="space-y-8">
          <TabsList className="bg-slate-50 dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm w-fit">
            <TabsTrigger
              value="overview"

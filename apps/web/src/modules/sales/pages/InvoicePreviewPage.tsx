          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {invoice.type === "pedido" ? "Proforma" : "Factura"} •{" "}
                {currency}
              </p>
            </div>
          </div>
        ...
        {isBs ? (
          function InvoiceTemplateBs({ invoice, tenant, rate, taxes }: any) {
            ...
            if (!invoice.items || !Array.isArray(invoice.items)) {
              ...
              return (
                <div className="p-8 text-center">
                  Error: La factura no tiene items válidos
                </div>
              );
            }
            ...
            return (
              <>
                {pages.map((page, pageIdx) => (
                  <main
                    key={pageIdx}
                    className="mx-auto flex justify-center p-4 md:p-12 page-break"
                  >
                    <article
                    ...
                    >
                      ...
                      <header className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xs text-slate-500 max-w-[240px] mt-1 leading-relaxed">
                            {tenant?.address || "Dirección no especificada"}
                            <br />
                            {tenant?.phone && (
                              <>
                                Tel: {tenant.phone}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        ...
                        <section className="flex flex-col justify-between border-2 border-slate-900 rounded-2xl p-5 relative overflow-hidden bg-white">
                          <div className="absolute top-0 right-0 px-3 py-1 bg-slate-100 dark:bg-slate-900 text-[10px] font-bold text-slate-900 dark:text-white uppercase tracking-tighter">
                            Factura Fiscal
                          </div>
                          <div className="grid grid-cols-2 gap-4 h-full">
                            <div className="flex flex-col justify-center border-r border-slate-100">
                              ...
                              <span className="text-xl font-mono font-medium text-slate-900">
                                {invoice.number}
                              </span>
                            </div>
                        ...
                        <table className="w-full text-left border-collapse">
                          <thead>
                            <tr className="border-b-2 border-slate-900">
                              <th className="py-2 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                                CAUPLAS
                              </th>
                              <th className="py-2 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                                Descripción
                              ...
                              <th className="py-2 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">
                                Precio Unit.
                              </th>
                              <th className="py-2 px-3 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">
                                Total Bs.
                          ...
                          <tbody className="text-sm">
                            {page.items.map((item: any, idx: number) => (
                              <tr
                                key={idx}
                                className={`border-b border-slate-50 ${idx % 2 === 0 ? "bg-slate-50" : ""}`}
                              >
                        ...
                        <section className="flex flex-col md:flex-row gap-6 items-start justify-between border-t border-slate-100 pt-6">
                          ...
                          <div className="w-full md:w-1/2 flex flex-col items-end">
                            <div className="w-full space-y-2">
                              ...
                              <div className="flex justify-between items-center py-1">
                                <div className="flex flex-col items-start">
                                  ...
                                  <span className="text-[9px] text-slate-400">
                                    (Sobre $
                                    {safeFormatNumber(invoice.total, "es-VE")}{" "}
                                    pagados)
                                  </span>
                                </div>
                                <span className="font-mono text-sm font-semibold text-slate-900">
                              ...
                              <div className="h-px bg-slate-200 dark:bg-slate-800 w-full my-3" />
                              <div className="flex justify-between items-center">
                                ...
                                <div className="text-right">
                                  <span className="block text-3xl font-bold text-slate-950 tracking-tighter">
                                    {safeFormatNumber(totalConIgtf, "es-VE")}{" "}
                                    Bs.
                                  </span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                          <div className="text-[9px] text-slate-400 uppercase tracking-widest leading-relaxed">
                            <p className="font-bold text-slate-600 mb-1">
                              Información de Imprenta Autorizada
                            </p>
                            <p>
                              Imprenta Digital Global, S.A. | RIF: J-00123456-0
                            </p>
                            <p>
                              Providencia SENIAT N° 00045/2023 | Fecha:
                              01/01/2023
                            </p>
                          ...
                          <div className="flex flex-col md:items-end gap-2">
                            <div className="w-20 h-20 bg-slate-50 border border-slate-100 flex items-center justify-center p-2 opacity-60">
                              <div className="w-full h-full border-2 border-dashed border-slate-300 flex items-center justify-center">
                                <span className="text-[8px] text-center px-1 font-bold text-slate-300">
                                  QR CODE
                                </span>
                              </div>
                            </div>
                            <p className="text-[10px] text-slate-400 font-medium">
                              Emitido por Violet ERP v2.4.0
                            </p>
                          </div>
                        </div>
                      </footer>
...
function InvoiceTemplateBs({ invoice, tenant, rate, taxes }: any) {
  if (!invoice) {
    console.error("Invoice is null or undefined");
    return (
      <div className="p-8 text-center">Error: No se encontró la factura</div>
    );
  }
  ...
  for (let i = 0; i < totalPages; i++) {
    ...
    const pageIva = invoice.metadata?.withIva
      ? pageSubtotal * ((taxes?.iva_general || 16) / 100)
      : 0;
          ...
          >
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        RIF:{" "}
                        {invoice.customer_rif || invoice.customerRif || "N/A"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
            ...
            <section className="mb-10 overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b-2 border-slate-900">
                    <th className="py-3 px-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                      CAUPLAS
                    </th>
                    <th className="py-3 px-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                      Descripción
                    ...
                    <th className="py-3 px-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">
                      Precio Unit.
                    </th>
                    <th className="py-3 px-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">
                      Total Bs.
                ...
                <tbody className="text-sm">
                  {page.items.map((item: any, idx: number) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-3 font-mono">
                        {safeFormatNumber(item.quantity || 0, "es-VE")}
                      </td>
                      <td className="py-3 px-3 text-right font-mono">
                      ...
                      <td className="py-3 px-3 text-right font-bold text-slate-900 font-mono">
                        {safeFormatNumber(
                          (item.total ||
                            (item.price || 0) * (item.quantity || 0)) * rate,
                          "es-VE",
                        )}
                      </td>
                    </tr>
            ...
            <section className="flex flex-col md:flex-row gap-8 items-start justify-between border-t border-slate-100 pt-8">
              ...
              {/* Totales */}
              <div
                className={`w-full ${page.pageNumber === totalPages ? "md:w-1/2" : "md:w-2/3 ml-auto"} flex flex-col items-end`}
              >
                  ...
                  {page.pageNumber === totalPages && (
                    <div className="flex justify-between items-center py-1">
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-[9px] text-slate-400">
                          (Sobre ${safeFormatNumber(page.total, "es-VE")}{" "}
                          pagados)
                        </span>
                      </div>
                      <span className="font-mono text-sm font-semibold text-slate-900">
            ...
            <footer className="mt-20 pt-8 border-t border-slate-100">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-end">
                ...
                <div className="flex flex-col md:items-end gap-2">
                  ...
                  <p className="text-[10px] text-slate-400 font-medium">
                    Emitido electrónicamente por Violet ERP v2.4.0
                  </p>
                </div>
              </div>
            </footer>

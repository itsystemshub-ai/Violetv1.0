/**
 * InventoryAnalyticsPage - Página de Análisis Predictivo con IA
 * Insights inteligentes, predicciones y recomendaciones automatizadas
 */
...
export default function InventoryAnalyticsPage() {
  ...
  return (
    <ValeryLayout sidebar={<ValerySidebar />}>
      {/* Animated Background */}
      <div className="fixed inset-0 bg-linear-to-br from-slate-50 via-purple-50/30 to-pink-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 -z-10 transition-colors duration-500" />

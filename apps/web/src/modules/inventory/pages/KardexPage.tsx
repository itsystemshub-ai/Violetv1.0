                        ...
                        >
                          ...
                          <td className="py-3 px-3 text-center">
                            <Button
                              variant="ghost"
                              size="icon"
                              className="w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300"
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Información completa de la operación de inventario.
            </DialogDescription>
          </DialogHeader>
          ...
          {selectedMovement && (
            <div className="space-y-4 pt-2">
              <div className="flex justify-between items-center pb-3 border-b border-border/50">
                ...
                >
                  {selectedMovement.reason || selectedMovement.type}
                </Badge>
              </div>
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-4 text-sm">
                <div>
                  ...
                  <p
                    ...
                    title={selectedMovement.productName}
                  >
                ...
                <div>
                  ...
                  <p className="font-mono bg-muted/50 px-2 py-1 rounded inline-block text-xs">
                ...
                <div>
                  ...
                  <p className="font-medium">{selectedMovement.warehouse}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-bold text-lg">
                    {formatCurrency(
                      Math.abs(selectedMovement.totalValue),
                      "USD",
                    )}
                  </p>
                </div>
                ...
                <div className="col-span-2">
                  ...
                  <p className="font-medium">
                    {selectedMovement.createdBy || "Sistema"}
                  </p>
                </div>
                ...
                {selectedMovement.notes && (
                  <div className="col-span-2 bg-muted/30 p-3 rounded-lg border border-border/50">
                    ...
                    <p className="text-sm italic">{selectedMovement.notes}</p>
                  </div>
                )}
              </div>
            </div>
